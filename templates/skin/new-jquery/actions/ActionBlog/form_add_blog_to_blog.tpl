...
{if $oUserCurrent->isAdministrator()}
    <p>
        ...
        <input type="text" id="order_num" name="order_num" value="{$data['order_num']}" class="w100p" /><br />
    </p>
    <p>
        <input type="checkbox" id="blogs_only" name="blogs_only" class="checkbox" value="1" {if $data['blogs_only'] ==1}checked{/if}/>
